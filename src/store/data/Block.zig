...
pub fn initFromData(io: Io, alloc: Allocator, timestampsEncoders: *TimestampsEncoder.Pool, data: *BlockData, unpacker: *Unpacker, decoder: *ValuesDecoder) !*Block {
    ...
    try TimestampsEncoder.decodeWithPool(timestampsEncoders, io, tss, data.timestampsData.data);
